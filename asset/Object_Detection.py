...
# Use default model name for our purposes by Seungmin
...
# Set path to current working directory by Seungmin
#CWD_PATH = os.getcwd()
...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            # added by Seungmin
            # if Human is detected and confidence Level is high enough:
            if object_name == 'person' and int(scores[i]*100) > 70:
                ...
                # Convert to base64 encoding and show first 80 bytes
                ...
                print("Human Detected. Image Captured.")

                # Save base64 encoding as TXT
                f = open("base64.txt", "w")
